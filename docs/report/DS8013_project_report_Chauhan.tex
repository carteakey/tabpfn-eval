...
\usepackage[style=numeric, backend=biber]{biblatex} % APA 7th edition style citations using biblatex
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.6\linewidth]{figures/TabPFN_architecture.png}
